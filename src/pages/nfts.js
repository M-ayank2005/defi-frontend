...
export default function Nfts() {
    ...
    try {
        ...
        console.log("mayank");
        console.log(res.ownedNfts.slice(0,40));
        ...
        <div>
            ...
            <div className='flex flex-row flex-wrap opacity-60 rounded-3xl w-full h-auto bg-black p-5  m-10 ml-5'>
                ...
                {details && details.map((detail, index) => (
                    <div className='w-72 h-96 border-2 m-4 p-2 rounded-2xl flex flex-col bg-gray-600'>
                        ...
                        <div key={index} className='flex flex-col p-2 bg-gray-900 opacity-70 rounded-b-3xl text-white'>
